        ...
        >
            ...
            >
                ...
                ><img
                        ...
                        src="https://arphros.ddns.net:5000/storage/avatar/{id}.png?width=200&height=200&fit=crop&auto=compress&mask=ellipse&fm=png"
                /></span
                >
                <img
                        alt="banner"
                        ...
                        src="https://arphros.ddns.net:5000/storage/banner/{id}.png"
                />
            </div>
                ...
                <div class="wrapper">
                    ...
                    <div class="space-y-4 flex flex-col">
                        <div class="flex flex-col p-3">
                            <form class="space-y-3 space-x-3" id="name-form">
                                <label class="text-2xl" for="username">Change username:</label><br/>
                                <input
                        ...
                        <div class="flex flex-col p-3">
                            <form class="space-y-3" id="avatar-form">
                                <label class="text-2xl" for="file">Change avatar:</label>
                                <input class="block w-full text-sm text-gray-500
									   ...
									   hover:file:bg-violet-100" id="file" name="avatar"
                                       type="file"
                                />
                                <input
                                        class="duration-200 p-2 rounded-full text-white bg-green-300/30 hover:bg-green-300/50 text-green-500 cursor-pointer shadow-lg shadow-green-500/30"
                        ...
                        <div class="flex flex-col p-3">
                            <form class="space-y-3" id="banner-form">
                                <label class="text-2xl" for="username">Change banner:</label>
                                <input class="block w-full text-sm text-gray-500
									   file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0
									   file:text-sm file:font-semibold file:bg-violet-50 file:text-violet-700
									   hover:file:bg-violet-100" id="banner" name="banner"
                                       type="file"
                                />
                                <input
                                        class="duration-200 p-2 rounded-full text-white bg-green-300/30 hover:bg-green-300/50 text-green-500 cursor-pointer shadow-lg shadow-green-500/30"
                        ...
                        <div class="flex md:flex-row flex-col gap-8 p-3">
                            <form class="space-y-3" id="logout-form">
                                <label class="text-2xl text-red-500" for="login">Logout of the account</label><br/>
                                <input
                            ...
                            <form class="space-y-3" id="delete-form">
                                <label class="text-2xl text-red-500" for="delete">Delete the account</label><br/>
                                <input
                                        class="duration-200 p-2 rounded-full text-white bg-red-300/30 hover:bg-red-300/50 text-red-500 cursor-pointer shadow-lg shadow-red-500/30"
                                        type="submit"
                                        value="Delete"
