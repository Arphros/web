	...
	<div class="h-full flex justify-center">
        ...
        -->
			...
			<div class="grid grid-flow-cols place-items-center md:grid-cols-2 grid-cols-1 m-4 gap-3">
				...
				<div class="sidewords">
					<center><img src="/assets/icons/database.png" alt="db" /></center>
				...
				<div class="sidewords">
					<center><img src="/assets/icons/team.png" alt="team" /></center>
					<p class="text-2xl text-gray-600 text-center">
			...
			<div class="flex lg:flex-row flex-col">
				<button
					...
					on:click={() => (check = 1)}
					><span class="text-3xl font-bold">1 Month</span><br />2 USD</button
				>
				<button
					class="p-16 m-6 shadow-xl text-center hover:bg-gray-200 hover:scale-110 transition-all duration-150 rounded-lg"
					on:click={() => (check = 2)}
					><span class="text-3xl font-bold">2 Month</span><br />4 USD</button
				>
				<button
					class="p-16 m-6 shadow-xl text-center hover:bg-gray-200 hover:scale-110 transition-all duration-150 rounded-lg"
					on:click={() => (check = 3)}
					><span class="text-3xl font-bold">3 Month</span><br />5 USD</button
				>
				<button
					class="p-16 m-6 shadow-xl text-center hover:bg-gray-200 hover:scale-110 transition-all duration-150 rounded-lg"
					on:click={() => (check = 4)}
					><span class="text-3xl font-bold">4 Month</span><br />6 USD</button
				>
			</div>
			{#if check !== 0}
