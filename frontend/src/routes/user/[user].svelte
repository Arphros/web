            ...
            >
                ...
                <div class="flex md:flex-row flex-col border-b">
                    ...
                    <div class="h-full w-full md:relative m-4 flex flex-col space-y-2">
                        ...
                        <h1 class="text-2xl">Exp: <span class="absolute right-4">{JSON.parse(data.user.info).exp}
                            exp(s)</span></h1>
                        <h1 class="text-2xl">
                            Play count: <span class="absolute right-4">{JSON.parse(data.user.info).playCount}
                            time(s)</span>
                        </h1>
                        <h1 class="text-2xl">
                            Replay watch: <span class="absolute right-4">{JSON.parse(data.user.info).replayWatch}
                            time(s)</span>
                        </h1>
                    </div>
                </div>
