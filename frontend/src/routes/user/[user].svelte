    ...
    <div class="h-full min-h-screen flex justify-center">
        ...
        >
            <div class="max-h-64 relative flex justify-center items-center rounded-t-xl overflow-hidden border-b border-black">
                <span class="z-50 absolute text-7xl text-white text-shadow-max center"><img src="/user/avatar/{user}.png" id="user-avatar" onerror="this.src = '/user/avatar/__default.png'" alt="avatar" class="rounded-full w-40 h-auto shadow-xl" /></span>
                <img
                        id="user-banner"
